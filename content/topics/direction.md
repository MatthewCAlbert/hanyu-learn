...
topic: direction
label: Direction
hanzi: [上, 下, 左, 右, 前, 后, 里, 外, 内]
words: [旁边, 中间, 右边, 左边, 里边, 外边, 后边, 西边, 上边, 东边, 南边, 北边, 下边, 前边, 方向, 南方, 对面, 西方, 北方, 东方, 东北, 西南, 西北, 东南, 里面, 上面, 后面, 左右, 外面, 下面, 周围, 前面, 背后, 当中, 西部, 南部, 东部, 北部, 底下, 前后, 中部, 两边, 后头, 前头]
---
